...
st.title('📈 A Dashboard for Stock Analysis')
st.markdown("""
...
with st.sidebar:
    ...
    symbols_input = st.text_input("Enter Stock Symbols (comma-separated)(only single working)", "AAPL, MSFT").upper()
